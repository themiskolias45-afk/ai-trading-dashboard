...
tools: Read, Grep, Glob, WebSearch, WebFetch, mcp__exa__web_search_exa, mcp__exa__web_fetch_exa, mcp__brave-search__brave_web_search, mcp__smartentry__read_memory, mcp__smartentry__write_memory, mcp__memory__create_entities, Bash, mcp__memory__search_nodes, Skill
---
...
```
mcp__memory__search_nodes query="research"
```
