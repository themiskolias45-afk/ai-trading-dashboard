...
tools: Read, Grep, Glob, Bash, mcp__smartentry__get_signals, mcp__smartentry__get_journal, mcp__smartentry__get_learning, mcp__smartentry__get_performance, mcp__smartentry__get_risk_status, mcp__smartentry__get_strategy_settings, mcp__smartentry__get_healer, mcp__smartentry__read_memory, mcp__smartentry__write_memory, mcp__smartentry__log_note, mcp__memory__create_entities, mcp__memory__search_nodes, Skill
---
...
```
mcp__memory__search_nodes query="finding"
```
